...
{{< card header="A plain card" title="This is an all purpose card." subtitle="Javascript" footer="Use markdown if syntax highlighting is required for code." >}}```javascript
const hello = "It me Tom";
