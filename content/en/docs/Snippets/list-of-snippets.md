...
{{% card-code header="javascript" lang="javascript" %}}```javascript
const highlight = "does this provide syntax highlighting?";

console.log(highlight); // does this provide syntax highlighting
```{{% /card-code %}}
